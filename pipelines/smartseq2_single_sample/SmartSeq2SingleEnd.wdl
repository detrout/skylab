...
workflow SmartSeq2SingleCell {
  ...
  call Picard.CollectMultipleMetricsForSingleEnd as CollectMultipleMetrics {
    input:
  ...
  call HISAT2.HISAT2SingleRSEM as HISAT2Transcriptome {
    input:
  ...
  call RSEM.RSEMSingleExpression as RSEMExpression {
    input:
